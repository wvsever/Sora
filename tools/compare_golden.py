...
summary.json "prior_year": counts, date and flags exactly, amounts to 1 cent (null exactly). nii.csv (net interest
income): amounts to 1 cent (or relative 1e-12), EIR and new business margins to 1e-9, position counts exactly;
summary.json "nii": counts and settings exactly, amounts to 1 cent.
