# REST client for the regulatory calculator (src/calculator.cpp, src/rea.cpp) and its tests.
...
if(SORA_BUILD_TESTS AND TARGET sora_tests)
  ...
  # Engine + stub calculator end to end (python/tests/test_calculator_engine.py; skips without the test data).
  ...
  if(Python3_FOUND)
    ...
    set_tests_properties(sora_calculator PROPERTIES ENVIRONMENT "SORA_ENGINE=$<TARGET_FILE:sora>" TIMEOUT 900)
  endif()
endif()
